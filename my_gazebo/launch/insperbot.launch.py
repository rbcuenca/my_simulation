...
def generate_launch_description():
    ...
    urdf_file = os.path.join(
        ...
        'urdf',
        'turtlebot3_burger_insper.gazebo.xacro'
    )
    ...
    spawn_entity = Node(
        ...
        arguments = ['-entity', 'InsperBot', '-topic', 'robot_description'],
        output ='screen')

    # Gazebo   
    world_file_name = 'empty_world.world'
    world = os.path.join(get_package_share_directory('my_gazebo'), 'worlds', world_file_name)
    ...
    rviz_config_file = get_package_share_directory('my_gazebo') + "/rviz/tb3_gazebo.rviz"
